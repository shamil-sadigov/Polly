...
namespace Polly
{
    ...
    public class ResultPredicates<TResult>
    {
        ...
        internal void Add(ResultPredicate<TResult> predicate)
        {
            ...
            // The ?? pattern here is sufficient; only a deliberately contrived example would
            // lead to the same PolicyBuilder instance being used in a multi-threaded way
            // to define policies simultaneously on multiple threads.
